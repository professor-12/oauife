    ...
    return (
        <div className="flex max-lg:flex-col gap-5">
            <div className="lg:w-4/5">
                <SlideAnimation />
                <div className="mt-12 w-full grid  gap-3 md:gird-cols-2  lg:grid-cols-4">
                    <div className="bg-violet-700/40 p-5 space-y-3 rounded-xl">
                        <svg
                            stroke="#FFFF"
                            fill="none"
                            strokeWidth="0"
                    ...
                    <div className="bg-violet-700 p-5 rounded-xl"></div>
                    <div className="bg-violet-700 p-5 rounded-xl"></div>
                    <div className="bg-violet-700 p-5 rounded-xl"></div>
                </div>
            </div>
